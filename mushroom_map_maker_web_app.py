...
Mushroom map maker web app

A flask app that delivers the mushroom map maker module to a user. Mushroom map maker is a program that
asks a user for the genus and species of a mushroom and uses that information to render a heatmap
of that mushroom's distribution across the globe using data from mushroomobserver.com.
'''
...
'''Creates instance of Flask as the object 'app', configures the flask object 'app', 
