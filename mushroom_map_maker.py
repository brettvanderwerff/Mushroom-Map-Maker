...
of that mushroom's distribution across the globe. This program is intended to be run
as an import of a mating web app 'mushroom_map_maker_web_app', but can also be run directly.
'''
...
def get_user_input():
    '''Function will take user input for assignment to genus_name and species_name.'''
    while True:
...
def draw_map(latitude_list, longitude_list):
    ...
    with the distribution of the user defined mushroom. Commented out lines represent optional map outputs.'''
    print('drawing map...')
